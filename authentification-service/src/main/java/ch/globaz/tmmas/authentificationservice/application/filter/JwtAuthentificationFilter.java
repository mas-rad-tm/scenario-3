...
import static ch.globaz.tmmas.authentificationservice.application.filter.SecurityConstants.EXPIRATION_TIME;
...
public class JwtAuthentificationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest req,
		...
		try {
			UtilisateursLdap creds = new ObjectMapper()
					.readValue(req.getInputStream(), UtilisateursLdap.class);
